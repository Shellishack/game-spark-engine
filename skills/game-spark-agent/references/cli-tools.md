...
```powershell
node engine/cli/dist/game-spark.js start --preview [--project <id-or-path>] [--workspace <path>] [--port <number|0>] [--open]
node engine/cli/dist/game-spark.js preview start [--project <id-or-path>] [--workspace <path>] [--port <number|0>] [--open]
node engine/cli/dist/game-spark.js preview rebuild --project <id-or-path> [--workspace <path>]
node engine/cli/dist/game-spark.js scene read [--project <id-or-path>] [--workspace <path>] [--scene <path>]
node engine/cli/dist/game-spark.js scene context [--project <id-or-path>] [--workspace <path>] [--scene <path>]
```
